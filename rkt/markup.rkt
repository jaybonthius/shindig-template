...
(define (svg source . text)
  (define svg-src (string-append "/media/images/" source ".svg"))
  `(figure (object [[type "image/svg+xml"] [data ,svg-src]])))

(define (tldraw source . text)
  (define tldr-dark-src (string-append "/media/images/tldraw/light.svg/" source ".svg"))
  (define tldr-light-src (string-append "/media/images/tldraw/dark.svg/" source ".svg"))
