(() => {
  // node_modules/.pnpm/unpoly@3.9.1/node_modules/unpoly/unpoly.js
  (() => {
    var __webpack_modules__ = [
      ...
      () => {
        up.util = function() {
          ...
          function variant(source, changes = {}) {
            let variant2 = Object.create(source);
            Object.assign(variant2, changes);
            return variant2;
          }
          return {
            parseURL,
      ...
      (__unused_webpack_module, __unused_webpack_exports, __webpack_require__2) => {
        ...
        up.element = function() {
          ...
          function stringAttr(element, attribute) {
            ...
            return u.replaceValue(value, null, void 0);
          }
        ...
        up.OptionsParser = class OptionsParser {
          ...
          parse(attrValueFn, key, keyOptions = {}) {
            ...
            for (let attrName of attrNames) {
              value ?? (value = this._parseFromAttr(attrValueFn, this._element, attrName));
            }
            value ?? (value = keyOptions.default ?? this._defaults[key]);
      ...
      () => {
        ...
        up.BodyShifter = class BodyShifter {
          constructor() {
            this._anchoredElements = /* @__PURE__ */ new Set();
            this._stack = 0;
            this._cleaners = [];
          }
          lowerStack() {
        ...
        up.RenderJob = (_a = class RenderJob {
          ...
          _handleResult(result) {
            if (result instanceof up.RenderResult) {
              ...
              let guardedOnFinished = function(result2) {
                up.error.guard(() => onFinished?.(result2));
              };
      ...
      () => {
        ...
        up.Change.FromResponse = (_a = class FromResponse extends up.Change {
          ...
          _augmentOptionsFromResponse(renderOptions) {
            ...
            renderOptions.time ?? (renderOptions.time = this._response.lastModified);
            renderOptions.etag ?? (renderOptions.etag = this._response.etag);
          }
        }, (() => {
          u.memoizeMethod(_a.prototype, {
        ...
        up.Change.FromContent = (_a = class FromContent extends up.Change {
          ...
          _improveOptionsFromResponseDoc() {
            ...
            if (this.options.fragment) {
              (_a2 = this.options).target || (_a2.target = responseDoc.rootSelector());
            }
        ...
        up.CompilerPass = class CompilerPass {
          ...
          _runCompiler(compiler) {
            ...
            if (!compiler.isDefault) {
              up.puts("up.hello()", 'Compiling %d\xD7 "%s" on %s', matches.length, compiler.selector, this._layer);
            }
            if (compiler.batch) {
          ...
          _selectOnce(compiler) {
            ...
            return u.filter(matches, (element) => {
              let appliedCompilers = element.upAppliedCompilers || (element.upAppliedCompilers = /* @__PURE__ */ new Set());
      ...
      () => {
        ...
        up.CSSTransition = class CSSTransition {
          ...
          _onTransitionEnd(event) {
            ...
            const elapsed = /* @__PURE__ */ new Date() - this._startTime;
      ...
      () => {
        ...
        up.FragmentPolling = class FragmentPolling {
          ...
          _getFragmentAge() {
            return /* @__PURE__ */ new Date() - this._lastAttempt;
          }
          _isOnFrontLayer() {
            this.layer || (this.layer = up.layer.get(this._fragment));
          ...
          _satisfyInterval() {
            this._lastAttempt = /* @__PURE__ */ new Date();
          }
        };
      },
      /* 48 */
      ...
      () => {
        ...
        up.Layer = class Layer extends up.Record {
          ...
          get index() {
            return this._index ?? (this._index = this.stack.indexOf(this));
          }
          getContentElement() {
          ...
          set location(location2) {
            ...
            location2 = u.normalizeURL(location2);
            if (previousLocation !== location2 || this.opening) {
              this.savedLocation = location2;
              if (this.showsLiveHistory()) {
                up.history.push(location2);
              }
              if (!this.opening) {
                this.emit("up:layer:location:changed", { location: location2 });
              }
            }
          }
          selector(part) {
      ...
      () => {
        ...
        up.Layer.Overlay = class Overlay extends up.Layer {
          ...
          _tryCloseForLocation(urlPattern, closeFn, options) {
            let location2, resolution;
            if (urlPattern && (location2 = this.location) && (resolution = urlPattern.recognize(location2))) {
              const closeValue = { ...resolution, location: location2 };
      ...
      () => {
        ...
        up.LinkFeedbackURLs = class LinkFeedbackURLs {
          ...
          isCurrent(normalizedLocation) {
            ...
            return !!(this._href === normalizedLocation || this._upHREF === normalizedLocation || this._aliasPattern?.test?.(normalizedLocation, false));
          }
        };
      },
      /* 61 */
    ...
    `;
      ...
      () => {
        ...
        up.Request = (_a = class Request extends up.Record {
          ...
          get age() {
            return /* @__PURE__ */ new Date() - this.builtAt;
          }
          header(name) {
      ...
      () => {
        ...
        class Route {
          constructor() {
            this.varyHeaders = /* @__PURE__ */ new Set();
            this.requests = [];
          }
      ...
      () => {
        ...
        up.Request.Queue = class Queue {
          ...
          _pluckNextRequest() {
            let request = u.find(this._queuedRequests, (request2) => !request2.background);
      ...
      () => {
        ...
        up.ResponseDoc = (_a = class ResponseDoc {
          constructor({ document: document2, fragment, content, target, origin, cspNonces, match }) {
            if (document2) {
              this._parseDocument(document2);
            } else if (fragment) {
        ...
        up.Selector = class Selector {
          constructor(selector, elementOrDocument, options = {}) {
            ...
            if (matchingInExternalDocument || options.layer === "any") {
              ...
              options.layer ?? (options.layer = u.presence(elementOrDocument, u.isElement));
      ...
      /***/
      () => {
        up.framework = /* @__PURE__ */ function() {
...
`;
      ...
      () => {
        up.history = function() {
          ...
          function replace(location2, options = {}) {
            location2 = u.normalizeURL(location2);
            if (manipulate("replaceState", location2) && options.event !== false) {
              emitLocationChanged({ location: location2, reason: "replace", log: `Replaced state for ${location2}` });
            }
          }
          function push(location2) {
            location2 = u.normalizeURL(location2);
            if (!isLocation(location2) && manipulate("pushState", location2)) {
              emitLocationChanged({ location: location2, reason: "push", log: `Advanced to location ${location2}` });
            }
          }
          ...
          function restoreStateOnPop(state) {
            ...
            up.error.muteUncriticalRejection(up.render({
              guardEvent: up.event.build("up:location:restore", { location: location2, log: `Restoring location ${location2}` }),
              url: location2,
          ...
          function onPop(event) {
            trackCurrentLocation();
            let location2 = currentLocation();
            emitLocationChanged({ location: location2, reason: "pop", log: `Navigated to history entry ${location2}` });
          ...
          function deriveTarget(element, deriver) {
            if (u.isFunction(deriver)) {
              ...
              try {
                ...
                if (e2 instanceof up.CannotParse) {
                  return deriver;
                } else {
                  throw e2;
                }
      ...
      (__unused_webpack_module, __unused_webpack_exports, __webpack_require__2) => {
        ...
        up.viewport = function() {
          ...
          const config = new up.Config(() => ({
            ...
            autoFocusVisible({ element, inputDevice }) {
              return inputDevice === "key" || up.form.isField(element);
            }
          }));
          ...
          function doFocus(element, { preventScroll, force, inputDevice, focusVisible } = {}) {
            ...
            inputDevice ?? (inputDevice = up.event.inputDevice);
            focusVisible ?? (focusVisible = "auto");
          ...
          function saveScroll(...args) {
            ...
            const location2 = options.location || options.layer.location;
            if (location2) {
              const tops = getScrollTopsForSave(viewports);
              options.layer.lastScrollTops.set(location2, tops);
            }
          }
          ...
          function restoreScroll(...args) {
            const [viewports, options] = parseOptions(args);
            const { location: location2 } = options.layer;
            const locationScrollTops = options.layer.lastScrollTops.get(location2);
          ...
          function saveFocus(options = {}) {
            ...
            const location2 = options.location || layer.location;
            if (location2) {
              const focusCapsule = up.FocusCapsule.preserve(layer);
              layer.lastFocusCapsules.set(location2, focusCapsule);
            }
          }
          function restoreFocus(options = {}) {
            const layer = up.layer.get(options);
            const location2 = options.location || layer.location;
            const locationCapsule = options.layer.lastFocusCapsules.get(location2);
      ...
      (__unused_webpack_module, __unused_webpack_exports, __webpack_require__2) => {
        ...
        up.network = function() {
          const config = new up.Config(() => ({
            ...
            wrapMethod: true,
            cacheSize: 70,
            cacheExpireAge: 15 * 1e3,
            cacheEvictAge: 90 * 60 * 1e3,
            badResponseTime: 400,
            fail(response) {
      ...
      (__unused_webpack_module, __unused_webpack_exports, __webpack_require__2) => {
        ...
        up.link = function() {
          ...
          function followOptions(link, options, parserOptions) {
            ...
            options.guardEvent ?? (options.guardEvent = up.event.build("up:link:follow", { log: ["Following link %o", link] }));
            return options;
          }
      ...
      () => {
        up.form = function() {
          ...
          function watchOptions(field, options, parserOptions = {}) {
            ...
            parser.string("event");
            parser.number("delay");
            let config2 = up.form.config;
            if (options.event === "input") {
              options.event = u.evalOption(config2.watchInputEvents, field);
              options.delay ?? (options.delay = config2.watchInputDelay);
            } else if (options.event === "change") {
              options.event = u.evalOption(config2.watchChangeEvents, field);
            }
          ...
          function destinationOptions(form, options, parserOptions) {
            ...
            const submitButton = options.submitButton ?? (options.submitButton = findSubmitButtons(form)[0]);
            if (submitButton) {
          ...
          function findSwitcherForTarget(target) {
            ...
            const switcher = u.find(switchers, function(switcher2) {
              const targetSelector = switcher2.getAttribute("up-switch");
  ...
  // resources/js/unpoly.ts
  var unpoly_default = window.up;
})();
